...
price_start_time <- simulated_price[, .(
  start_time = min(entry_time)
), tripID]
Rprice <- request_R(fit_price, price_start_time$start_time, price_start_time$start_time, simulated_price$distance_meters, K = 0.9, risk_free = 0, zeta = 0)
Kprice <- request_K(fit_price, simulated_price$distance_meters, discount_factor = 0.9)
test_start_time <- simulated_test[, .(
  start_time = min(entry_time)
), tripID]
Rtest <- request_R(fit_test, test_start_time$start_time, test_start_time$start_time, simulated_test$distance_meters, K = 0.9, risk_free = 0, zeta = 0)
Ktest <- request_K(fit_test, simulated_test$distance_meters, discount_factor = 0.9)
```
