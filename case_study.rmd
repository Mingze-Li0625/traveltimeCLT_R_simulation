...
groups <- pair_counts[count >= group_size, ]
simulated_data <- simulated_data[,
  {
    ...
    id2 <- sample.int(nrow(trip_set), group_size)
    .(
      trip = trip_set$trip[id],
      start_time = trip_set$start_time[id],
      trip2 = trip_set$trip[id],
      start_time2 = trip_set$start_time[id]
    )
  },
  by = repeat_time
]
simulated_test <- similar_route(simulated_data$trip, trips, r = X, sigma_n = sigma_n, significance = significance_level,Ftest_sd = F)
simulated_price <- similar_route(simulated_data$trip2, trips, r = X, sigma_n = sigma_n, significance = significance_level,Ftest_sd = F)

setnames(simulated_price,"trip","trip2")
simulated_price <- merge(simulated_price, simulated_data[, c("trip2", "start_time2")], by = "trip2")
setnames(simulated_price, old = c("newtrip", "linkId", "length", "start_time2"), new = c("tripID", "linkID", "distance_meters", "entry_time"), skip_absent = TRUE)
