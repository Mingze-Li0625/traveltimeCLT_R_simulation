...
Percentage_profit <- c(
    mean(((R1 + 1 * K1) - user_data$real_price) / user_data$real_price),
    mean(((R1 + exp(0.05) * K1) - user_data$real_price) / user_data$real_price),
    mean(((R1 + exp(0.1) * K1) - user_data$real_price) / user_data$real_price),
    mean(((R2 + 1 * K2) - user_data$real_price) / user_data$real_price),
    mean(((R2 + exp(0.05) * K2) - user_data$real_price) / user_data$real_price),
    mean(((R2 + exp(0.1) * K2) - user_data$real_price) / user_data$real_price)
)
Average_profit <- c(
    mean((R1 + 1 * K1) - user_data$real_price),
    mean((R1 + exp(0.05) * K1) - user_data$real_price),
    mean((R1 + exp(0.1) * K1) - user_data$real_price),
    mean((R2 + 1 * K2) - user_data$real_price),
    mean((R2 + exp(0.05) * K2) - user_data$real_price),
    mean((R2 + exp(0.1) * K2) - user_data$real_price)
)
Maximum_Loss <- c(
    min((R1 + 1 * K1) - user_data$real_price),
    min((R1 + exp(0.05) * K1) - user_data$real_price),
    min((R1 + exp(0.1) * K1) - user_data$real_price),
    min((R2 + 1 * K2) - user_data$real_price),
    min((R2 + exp(0.05) * K2) - user_data$real_price),
    min((R2 + exp(0.1) * K2) - user_data$real_price)
)
```
