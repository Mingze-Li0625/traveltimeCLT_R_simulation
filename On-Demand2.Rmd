...
plot7 <- ggplot(travel_time) +
  stat_ecdf(aes(x = sampled_time, color = "Sampled Data")) +
  stat_ecdf(aes(x = non_dependent_time, color = "Non-dependent")) +
  stat_ecdf(aes(x = dependent, color = "Full-dependent")) +
  stat_ecdf(aes(x = first_order_time, color = "1st-order")) +
  stat_ecdf(aes(x = second_order_time, color = "2nd-order")) +
  stat_ecdf(aes(x = population_time, color = "Population")) +
  stat_ecdf(aes(x = HMM, color = "HMM")) +
  labs(
