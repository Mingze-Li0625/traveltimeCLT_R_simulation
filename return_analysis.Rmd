...
sample <- sample_route(id, trips, 1001, timeBin_x_edge, abuse_ratio = 0, abuse_multiplier = 1)
pressure_test <- sample_route(id, trips, 1001, timeBin_x_edge, abuse_ratio = 0.6, abuse_multiplier = 1.4)
```
